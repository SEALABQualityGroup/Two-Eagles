...
public class IntegratedSMG extends AbstractHandler {
	
	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String INTEGRATED_SEMANTIC_MODEL_GENERATOR = "-e";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Integrated semantic model generator */
		Utility.execute(window.getShell(), "Compiling...", twoTowers, INTEGRATED_SEMANTIC_MODEL_GENERATOR, source, dest);
