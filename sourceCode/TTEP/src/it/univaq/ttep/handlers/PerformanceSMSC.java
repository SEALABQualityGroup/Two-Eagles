...
public class PerformanceSMSC extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String PERFORMANCE_SEMANTIC_MODEL_SIZE_CALCULATOR = "-d";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Performance semantic model size calculator */
		Utility.execute(window.getShell(), "Compiling...", twoTowers, PERFORMANCE_SEMANTIC_MODEL_SIZE_CALCULATOR, source, dest);
