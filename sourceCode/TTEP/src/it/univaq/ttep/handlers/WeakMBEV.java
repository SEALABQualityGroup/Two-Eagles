...
public class WeakMBEV extends AbstractHandler {

	private final static String WEAK_MARKOVIAN_BISIMULATION = "-k";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Utility.execute(window.getShell(), "Verifying...", twoTowers, WEAK_MARKOVIAN_BISIMULATION, source, source_2, dest);
