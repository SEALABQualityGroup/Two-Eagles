...
public class NonInterference extends AbstractHandler {

	private final static String NON_INTERFERENCE_ANALYZER = "-n";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		final String source_2 = Utility.queryFile(window.getShell(), EXTENSIONS, myWorkspaceRoot.getLocation().toString()+sourcePath.removeLastSegments(1).toString()).toString();
		Utility.execute(window.getShell(), "Analyzing...", twoTowers, NON_INTERFERENCE_ANALYZER, source, source_2, dest);
