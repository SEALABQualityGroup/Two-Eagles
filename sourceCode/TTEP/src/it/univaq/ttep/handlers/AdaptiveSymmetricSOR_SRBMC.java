...
public class AdaptiveSymmetricSOR_SRBMC extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String STATIONARY_REWARD_BASED_MEASURE_CALCULATOR_ADAPTIVE_SYMMETRIC_SOR = "-t";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Stationary reward based measure calculator (adaptive symmetric SOR) */
		...
		Utility.execute(window.getShell(), "Calculating...", twoTowers, STATIONARY_REWARD_BASED_MEASURE_CALCULATOR_ADAPTIVE_SYMMETRIC_SOR, source, source_2, dest);
