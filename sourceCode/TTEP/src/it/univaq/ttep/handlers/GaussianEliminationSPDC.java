...
public class GaussianEliminationSPDC extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String STATIONARY_PROBABILITY_DISTRIBUTION_CALCULATOR_GAUSSIAN_ELIMINATION = "-p";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Utility.execute(window.getShell(), "Calculating...", twoTowers, STATIONARY_PROBABILITY_DISTRIBUTION_CALCULATOR_GAUSSIAN_ELIMINATION, source, dest);
