...
public class TransientRewardBased extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String TRANSIENT_REWARD_BASED_MEASURE_CALCULATOR_UNIFORMIZATION = "-u";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Transient reward based measure calculator (uniformization) */
		...
		Utility.execute(window.getShell(), "Calculating...", twoTowers, TRANSIENT_REWARD_BASED_MEASURE_CALCULATOR_UNIFORMIZATION, source, value, source_2, dest);
