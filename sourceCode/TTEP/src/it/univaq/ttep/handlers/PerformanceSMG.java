...
public class PerformanceSMG extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String PERFORMANCE_SEMANTIC_MODEL_GENERATOR = "-g";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Performance semantic model generator */
		Utility.execute(window.getShell(), "Compiling...", twoTowers, PERFORMANCE_SEMANTIC_MODEL_GENERATOR, source, dest);
