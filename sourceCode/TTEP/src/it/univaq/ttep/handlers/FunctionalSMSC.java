...
public class FunctionalSMSC extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String FUNCTIONAL_SEMANTIC_MODEL_SIZE_CALCULATOR = "-c";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Functional semantic model size calculator */
		Utility.execute(window.getShell(), "Compiling...", twoTowers, FUNCTIONAL_SEMANTIC_MODEL_SIZE_CALCULATOR, source, dest);
