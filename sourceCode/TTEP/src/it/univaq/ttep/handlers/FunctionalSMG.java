...
public class FunctionalSMG extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String FUNCTIONAL_SEMANTIC_MODEL_GENERATOR = "-f";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/* Functional semantic model generator */
		Utility.execute(window.getShell(), "Compiling...", twoTowers, FUNCTIONAL_SEMANTIC_MODEL_GENERATOR, source, dest);
