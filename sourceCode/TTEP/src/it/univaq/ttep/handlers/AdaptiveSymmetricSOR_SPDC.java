...
public class AdaptiveSymmetricSOR_SPDC extends AbstractHandler {

	/* Parametro da passare a TTKernel per lanciare la funzionalità opportuna */
	private final static String STATIONARY_PROBABILITY_DISTRIBUTION_CALCULATOR_ADAPTIVE_SYMMETRIC_SOR = "-q";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Utility.execute(window.getShell(), "Calculating...", twoTowers, STATIONARY_PROBABILITY_DISTRIBUTION_CALCULATOR_ADAPTIVE_SYMMETRIC_SOR, source, dest);
