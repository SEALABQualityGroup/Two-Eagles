...
public class WeakBEV extends AbstractHandler {

	private final static String WEAK_BISIMULATION = "-i";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Utility.execute(window.getShell(), "Verifying...", twoTowers, WEAK_BISIMULATION, source, source_2, dest);
