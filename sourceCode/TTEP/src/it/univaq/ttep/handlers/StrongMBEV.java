...
public class StrongMBEV extends AbstractHandler {

	private final static String STRONG_MARKOVIAN_BISIMULATION = "-j";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Utility.execute(window.getShell(), "Verifying...", twoTowers, STRONG_MARKOVIAN_BISIMULATION, source, source_2, dest);
