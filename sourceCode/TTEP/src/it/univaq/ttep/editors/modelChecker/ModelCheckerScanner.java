...
import it.univaq.ttep.editors.modelChecker.IModelCheckerColorConstants;
import java.util.ArrayList;
import java.util.List;

public class ModelCheckerScanner extends RuleBasedScanner {
	...
	public ModelCheckerScanner(ColorManager manager) {
		IToken keyword = new Token(new TextAttribute(manager.getColor(IModelCheckerColorConstants.Aemilia_KEYWORD), null, SWT.BOLD));
		IToken other = new Token(new TextAttribute(manager.getColor(IModelCheckerColorConstants.DEFAULT)));
		IToken type = new Token(new TextAttribute(manager.getColor(IModelCheckerColorConstants.Aemilia_TYPE), null, SWT.BOLD));
		IToken mathFunction = new Token(new TextAttribute(manager.getColor(IModelCheckerColorConstants.Aemilia_MATHEMATICAL_FUNCTION), null, SWT.BOLD));
		IToken randomGenerator = new Token(new TextAttribute(manager.getColor(IModelCheckerColorConstants.Aemilia_PSEUDO_RANDOM_GENERATOR), null, SWT.BOLD));
		IToken auxKeyword = new Token(new TextAttribute(manager.getColor(IModelCheckerColorConstants.AUX_KEYWORD), null, SWT.BOLD));
