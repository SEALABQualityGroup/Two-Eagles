...
public class SecurityScanner extends RuleBasedScanner {
	...
	public SecurityScanner(ColorManager manager) {
		IToken keyword = new Token(new TextAttribute(manager.getColor(ISecurityColorConstants.Aemilia_KEYWORD), null, SWT.BOLD));
		IToken other = new Token(new TextAttribute(manager.getColor(ISecurityColorConstants.DEFAULT)));
		IToken type = new Token(new TextAttribute(manager.getColor(ISecurityColorConstants.Aemilia_TYPE), null, SWT.BOLD));
		IToken mathFunction = new Token(new TextAttribute(manager.getColor(ISecurityColorConstants.Aemilia_MATHEMATICAL_FUNCTION), null, SWT.BOLD));
		IToken randomGenerator = new Token(new TextAttribute(manager.getColor(ISecurityColorConstants.Aemilia_PSEUDO_RANDOM_GENERATOR), null, SWT.BOLD));
		IToken auxKeyword = new Token(new TextAttribute(manager.getColor(ISecurityColorConstants.AUX_KEYWORD), null, SWT.BOLD));
