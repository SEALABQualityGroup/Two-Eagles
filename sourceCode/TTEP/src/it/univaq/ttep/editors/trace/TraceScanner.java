...
public class TraceScanner extends RuleBasedScanner {
	...
	public TraceScanner(ColorManager manager) {
		IToken keyword = new Token(new TextAttribute(manager.getColor(ITraceColorConstants.Aemilia_KEYWORD), null, SWT.BOLD));
		IToken other = new Token(new TextAttribute(manager.getColor(ITraceColorConstants.DEFAULT)));
		IToken type = new Token(new TextAttribute(manager.getColor(ITraceColorConstants.Aemilia_TYPE), null, SWT.BOLD));
		IToken mathFunction = new Token(new TextAttribute(manager.getColor(ITraceColorConstants.Aemilia_MATHEMATICAL_FUNCTION), null, SWT.BOLD));
		IToken randomGenerator = new Token(new TextAttribute(manager.getColor(ITraceColorConstants.Aemilia_PSEUDO_RANDOM_GENERATOR), null, SWT.BOLD));
		IToken auxKeyword = new Token(new TextAttribute(manager.getColor(ITraceColorConstants.AUX_KEYWORD), null, SWT.BOLD));
