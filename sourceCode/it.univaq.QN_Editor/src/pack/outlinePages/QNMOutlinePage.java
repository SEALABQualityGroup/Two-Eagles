...
import pack.factories.QNMTreeEditPartFactory;
import pack.model.IQNM;

public class QNMOutlinePage extends ContentOutlinePage {
	...
	public QNMOutlinePage(EditPartViewer viewer, 
	...
	public void createControl(Composite parent) 
		...
		getViewer().setEditPartFactory(new QNMTreeEditPartFactory(iqnm,actionRegistry));
