...
public class NodeType 
	...
	public void addWorkUnitServer(WorkUnitServerType value) {
		appendDomElement(null, "WorkUnitServer", value);
	}
	...
	public void removeSinkNodeAt(int index) {
		removeDomChildAt(Element, null, "SinkNode", index);
	}
	
	public void removeSourceNodeAt(int index) {
		removeDomChildAt(Element, null, "SourceNode", index);
	}
