...
public class SinkNodeTypeTreeEditPart extends AbstractTreeEditPart implements
	...
	protected Image getImage() 
		{
		InputStream stream = PMIFPlugin.class.getResourceAsStream("icons/Queueing Network Sink.bmp");
	...
	protected String getText() 
		{
		SinkNodeModel model = (SinkNodeModel)getModel();
