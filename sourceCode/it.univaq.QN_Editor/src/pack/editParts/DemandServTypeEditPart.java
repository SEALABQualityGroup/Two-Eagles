...
public class DemandServTypeEditPart 
	...
	private IFigure createFigureForModel() 
		...
		// ad una figura
		if (getModel() instanceof DemandServModel) 
			{
			DemandServModel demandServModel = (DemandServModel)getModel();
			Image image = Utility.createImage("icons/DemandServiceRequest_32X32.bmp");
			Etichetta label = null;
			label = new Etichetta(image);
			label.impostaEtichetta(demandServModel.getServerID());
	...
	protected void refreshVisuals() 
		{
		// notify parent container of changed location
