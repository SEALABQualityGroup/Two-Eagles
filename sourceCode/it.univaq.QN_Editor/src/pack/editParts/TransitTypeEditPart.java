...
import pack.commands.TransitTypeDeleteCommand;
import pack.editPolicies.TransitBendpointEditPolicy;
...
public class TransitTypeEditPart 
	...
	protected void createEditPolicies() 
		...
		installEditPolicy(EditPolicy.CONNECTION_ROLE, new ConnectionEditPolicy() 
			...
			protected Command getDeleteCommand(GroupRequest request) 
				{
				try {
					return new TransitTypeDeleteCommand(getCastedModel());
					} 
				catch (Exception e) 
					{
					return null;
		...
		installEditPolicy(EditPolicy.CONNECTION_BENDPOINTS_ROLE, new TransitBendpointEditPolicy());
		}
	
	private ITransit getCastedModel() 
		{
		return (ITransit) getModel();
		}
	...
	public void refreshBendpoints()
		{
		List<TransitTypeBendpoint> modelConstraint = getCastedModel().getBendpoints();
