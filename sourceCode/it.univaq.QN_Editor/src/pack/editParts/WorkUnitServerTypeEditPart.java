...
public class WorkUnitServerTypeEditPart 
	...
	public WorkUnitServerTypeEditPart(IQNM type) 
		{
		super();
		this.type = type;
		}
	...
	private IFigure createFigureForModel() 
		...
		// ad una figura
		if (getModel() instanceof WorkUnitServerModel) 
			{
			WorkUnitServerModel workUnitServerModel = (WorkUnitServerModel)getModel();
			Image image = Utility.createImage("icons/Queueing Network Blu.bmp");
			Etichetta label = null;
			label = new Etichetta(image);
			label.impostaEtichetta(workUnitServerModel.getServerName());
	...
	private WorkUnitServerModel getCastedModel() 
		{
		return (WorkUnitServerModel) getModel();
		}
