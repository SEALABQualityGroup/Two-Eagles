...
public class ServerTypeEditPart 
	...
	public ServerTypeEditPart(IQNM type) 
		{
		super();
		this.type = type;
		}
	...
	private IFigure createFigureForModel() 
		...
		// ad una figura
		if (getModel() instanceof ServerModel) 
			{
			ServerModel serverModel = (ServerModel)getModel();
			Image image = Utility.createImage("icons/Queueing Network Red.bmp");
			Etichetta label = new Etichetta(image);
			label.impostaEtichetta(serverModel.getServerName());
	...
	protected void refreshVisuals() 
		...
		Rectangle bounds = new Rectangle(getCastedModel().getLocation(),getCastedModel().getEtichetta().getSize());
		((GraphicalEditPart) getParent()).setLayoutConstraint(this, getFigure(), bounds);		
		}
	
	private ServerModel getCastedModel() 
		{
		return (ServerModel) getModel();
		}
