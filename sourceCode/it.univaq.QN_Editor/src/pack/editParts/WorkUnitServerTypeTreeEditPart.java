...
public class WorkUnitServerTypeTreeEditPart extends AbstractTreeEditPart
	...
	protected Image getImage() 
		{
		InputStream stream = PMIFPlugin.class.getResourceAsStream("icons/Queueing Network Blu.bmp");
	...
	protected String getText() 
		{
		WorkUnitServerModel model = (WorkUnitServerModel)getModel();
