...
public class SinkNodeTypeEditPart 
	...
	public SinkNodeTypeEditPart(IQNM iqnm) 
		{
		super();
		this.type = iqnm;
		}
	...
	private IFigure createFigureForModel() 
		...
		// ad una figura
		if (getModel() instanceof SinkNodeModel) 
			{
			SinkNodeModel sinkNodeModel = (SinkNodeModel)getModel();
			Image image = Utility.createImage("icons/Queueing Network Sink.bmp");
			Etichetta label = null;
			label = new Etichetta(image);
			label.impostaEtichetta(sinkNodeModel.getServerName());
	...
	private SinkNodeModel getCastedModel() 
		{
		return (SinkNodeModel) getModel();
		}
