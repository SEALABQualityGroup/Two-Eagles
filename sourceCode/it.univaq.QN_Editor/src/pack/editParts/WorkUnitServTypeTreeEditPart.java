...
public class WorkUnitServTypeTreeEditPart extends AbstractTreeEditPart
	...
	protected Image getImage() 
		{
		InputStream stream = PMIFPlugin.class.getResourceAsStream("icons/WorkUnitServiceRequest_32X32.bmp");
	...
	protected String getText() 
		{
		WorkUnitServModel model = (WorkUnitServModel)getModel();
