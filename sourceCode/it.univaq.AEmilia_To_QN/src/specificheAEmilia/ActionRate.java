 ...
 * </pre>
 * </code>
 * Il tasso di un'azione temporizzata esponenzialmente (exp) è data
 * da un'espressione, il cui valore deve essere un reale positivo,
 * ed è interpretato come il tasso della variabile casuale
 * distribuita esponenzialmente che descrive la durata
 * dell'azione. Il tasso di un'azione immediata (inf) è espresso
 * attraverso una priorità , data da un'espressione il cui
 * valore deve essere un intero non minore di uno, e un peso,
 * dato da un'espressione il cui valore deve essere un reale
 * positivo. Il tasso di un'azione passiva (_) è di nuovo espressa
 * attraverso attraverso due espressioni che denotano una priorità 
 * ed un peso, rispettivamente. Se non è specificato, i valori
 * della priorità  e il peso di un'azione passiva o immediata
 * sono uno.
 *
...
public class ActionRate {
	...
	/**
	 * Indica se questo oggetto è uguale all'argomento del metodo.
	 * @param ar - oggetto ActionRate da cofrontare.
	 * @return un valore booleano che indica se questo
	 * oggetto è uguale all'argomento del suo metodo.
	 */
	/*
