 ...
 * </code>
 * </pre>
 * Tale forma Ë utile per dichiarare in modo conciso diversi
 ...
 * loro intervalli, ognuno dei quali Ë dato da due espressioni
 ...
 * espressione non pi√π grande del valore della seconda espressione.
 ...
 * passiva, al pi√π una puÚ essere un'azione non passiva nel
...
public class AttacDeclInd 
	 ...
	 * @param index1 - oggetto String che indica l'identificatore
	 * per la prima indicizzazione.
	 * @param beginningExpr1 - oggetto Expression che indica
	 * l'espressione di inizio per la prima indicizzazione.
	 * @param endingExpr1 - oggetto Expression che indica
	 * l'espressione di fine per la prima indicizzazione.
	 * @param index2 - oggetto String che indica l'identificatore
	 * per la seconda indicizzazione.
	 * @param beginningExpr2 - oggetto Expression che indica
	 * l'espressione di inizio per la seconda indicizzazione.
	 * @param endingExpr2 - oggetto Expression che indica
	 * l'espressione di fine per la seconda indicizzazione.
	 */
	public AttacDeclInd(String outputAei, 
			Expression fromSelector, 
			String inputInteraction, String inputAei, 
			Expression toSelector, String outputInteraction,
			String index1, Expression beginningExpr1, 
		...
		super(outputAei, fromSelector, inputInteraction, inputAei, toSelector,
				outputInteraction);
	...
	public void print()
		...
		// la seconda indicizzazione puÚ essere opzionale
		if (getIndex2() != null)
			{
