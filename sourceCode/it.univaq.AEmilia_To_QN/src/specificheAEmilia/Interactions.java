...
/**
 * Classe utilizzta per generalizzare le interazioni di input e output.
 * Contiene gli attributi uni, or e and utilizzati dalle classi InputInteractions e OutputInteractions.
 * 
 * @author Mirko
 *
 */
public class Interactions 
	...
	public void print() 
		...
		if (getUni() != null) getUni().print();
		// possono non esserci or-interazioni
		if (getOr() != null) getOr().print();
		// possono non esserci and-interazioni
		if (getAnd() != null) getAnd().print();
		}

	@Override
	public boolean equals(Object arg0) 
		{
		if (!(arg0 instanceof Interactions)) return false;
