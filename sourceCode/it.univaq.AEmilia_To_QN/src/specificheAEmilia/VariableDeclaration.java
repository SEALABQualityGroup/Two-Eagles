 ...
 * variabile. Nessuna espressione di inizializzazione è necessaria
 * per i parametri formali variabili di ogni equazione
 * comportamentale susseguente, poichè, ad essi, saranno
...
public class VariableDeclaration extends ParamDeclaration {
	...
	/**
	 * Restituisce true se e solo se questo oggetto è uguale a v.
