...
/**
 * La costante stop rappresenta il termine di processo che non può
 * eseguire nessuna azione. In AEmilia, la sua sintassi è la
 * seguente:
 * <pre>
 * <code>
 * "stop"
...
public class Stop extends ProcessTerm {
	...
	/**
	 * Restituisce true se e solo se questo oggetto è uguale a s.
