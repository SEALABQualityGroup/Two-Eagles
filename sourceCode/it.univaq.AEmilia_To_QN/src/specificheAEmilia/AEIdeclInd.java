 ...
 * </code>
 * </pre>
 * Tale forma è utile per dichiarare in maniera concisa diverse
 * istanze dello stesso AET attraverso un meccanismo di
 * indicizzazione. Questa richiede la specifica dell'identificatore
 * indice, che si può presentare nell'espressione di selezione e
 * nei parametri attuali, insieme con il suo intervallo, che è
