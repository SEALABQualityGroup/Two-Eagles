 ...
 *  indice, che si può successivamente presentare nell'espressione
 * di selezione, insieme con il suo intervallo, che è dato da due
 ...
 * non piÃ¹ grande del valore della seconda espressione.
 *
...
public class InteractionDeclInd 
	...
	/**
	 * Restituisce l'espressione il cui valore è l'ultimo assunto
	...
	/**
	 * Restituisce l'espressione il cui valore è il primo assunto
	 *  dall'indice per la dichiarazione di un'interazione.
	 * @return un oggetto Expression.
	 */
