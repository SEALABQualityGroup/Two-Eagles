 ...
 * può essere presente in una specifica AEmilia. Ha la seguente
 * sintassi:
 * <pre>
 * <code>
...
public class ConstInit extends ParamDeclaration {
	 ...
	 */
	public ConstInit(String name, DataType type, Expression expr) 
		{
		setName(name);
		this.type = type;
		this.expr = expr;
	...
	/**
	 * Confronta se questo oggetto è uguale all'oggetto fornito
	 * come parametro.
	 * @param ci - oggetto ConstInit da confrontare.
	 * @return true se e solo se questo oggetto è uguale
	 * a ci.
	 */
	/*
