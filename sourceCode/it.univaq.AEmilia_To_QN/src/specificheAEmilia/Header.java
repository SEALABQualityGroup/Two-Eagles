 ...
 * un'intestazione in una specifica AEmilia.
 * Un'intestazione viene utilizzata dopo la parola chiave
 * "ARCHI_TYPE", "ELEM_TYPE" e nella definizione di un'equazione
 * comportamentale.
 * L'intestazione del tipo architetturale all'inizio di una
 ...
 * è o void o una sequenza non vuota di dichiarazioni separate da
 * virgole di parametri formali costanti. L'intestazione della
...
public class Header {
	...
	/**
	 * Crea un oggetto Header con nome e parametri formali
	 * forniti come parametri.
	 * @param name - oggetto String.
	 * @param parameters - array di oggetti ParamDeclaration.
	 */
	...
	/**
	 * Restituisce l'array di dichiarazioni di
	...
	/**
	 * Stampa sullo standard output le informazioni che
	 * caratterizzano un'intestazione.
	 *
	 */
	public void print()
		{
	...
	/**
	 * Restituisce true se e solo se i è uguale a
	 * questa intestazione.
	 * @param i - oggetto Header.
	...
	public String toString() 
		...
		if (this.parameters != null && this.parameters.length > 0)
			...
			for (int i = 0; i < this.parameters.length - 1; i++)
				...
				// In questo caso, se l'elemento successivo è un VarInit si separa con
				// la virgola, altrimenti con un punto e virgola
				// 4) se paramDeclaration è VariableDeclaration siamo di fronte all'intestazione
				// di un'equazione comportamentale che non è la prima e this.Parametri
				// rappresenta una sequenza non vuota separata da virgole.
				// In questo caso, se l'elemento successivo è un VariableDeclaration si separa con
				// la virgola, altrimenti con un punto e virgola
				if (paramDeclaration instanceof ConstInit)
					...
					{
					// caso in cui c'è una dichiarazione di sequenza void
					string = string + "void" + ";";
					}
				}
