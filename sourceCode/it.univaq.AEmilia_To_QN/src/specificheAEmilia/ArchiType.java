 ...
 * di un tipo architetturale. Tale descrizione è composta da
 * tre sezioni:
 * <pre>
 * <code>
 ...
 * &lt;init_const_formal_par_decl_sequence&gt; è o void o una sequenza non vuota di dichiarazioni
...
public class ArchiType {
	...
	/**
	 * Confronta se questo oggetto è uguale al parametro del metodo
