...
public class ScanLisFile {
	 ...
	 * stringa è vuota. La seconda stringa contiene un
	 * messaggio di presenza di warnings o errori. Se non ci
	 * sono errori o warnings, tale stringa è vuota.
	 *
	...
	public static String[] scanLisFile(File lis)
		...
		try
			...
			s1.skip("\\s*>>>>\\s*");
			int wars = s1.nextInt();
			// se il numero di errori è maggiore di
			...
			// se il numero di warnigs è maggiore di
