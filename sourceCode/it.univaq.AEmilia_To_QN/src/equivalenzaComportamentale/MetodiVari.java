...
public class MetodiVari 
	...
	// processTerm2. processTerm può avere foglie uguali a null. Se a processTerm non può
	...
	public static ProcessTerm somma(ProcessTerm processTerm,
		...
		// 1) processTerm è null
		if (processTerm == null)
			return processTerm2;
		// 2) processTerm è stop
		if (processTerm instanceof Stop)
			return null;
		// 3) processTerm è ActionProcess
	...
	// da processTerm2. processTerm2 può avere foglie uguali a null e deve essere
	// un sottocomportamento di processTerm. 
	// Se non è un sottocomportamento di
	...
	public static List<ProcessTerm> differenza(ProcessTerm processTerm,
		...
		// 3) processTerm2 è ActionProcess
		...
		// 4) processTerm2 è ChoiceProcess
	...
	public static boolean isOnlyReal(Expression expression)
		{
		// se non è un real si restiuisce false
	...
	public static boolean isOnlyInteger(Expression expression)
		{
		// se non è un Integer si restiuisce false
	 ...
	 * Se processTerm è uno ChoiceProcess si restituisce la coda del primo processo.
	 */
