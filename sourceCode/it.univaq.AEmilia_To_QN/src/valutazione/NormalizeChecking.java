...
public class NormalizeChecking {
	...
	/**
	 * Restituisce true se e solo se e è un'espressione normalizzata.
	 *
	 * @param e
	 * @return
	 */
	public static boolean isNormalizedExp(Expression e)
		...
		// da false nel caso in cui e sia di tipo
		// DataType, NormalType o Expression
		else return false;
		}

	/**
	 * Restituisce true se e solo se aeid è una dichiarazione di istanza normalizzata.
	 *
	 * @param aeid
	 * @return
	 */
	public static boolean isNormalizedAEIdecl(AEIdecl aeid)
		...
		if (aeid.getSelector() != null) return false;
	...
	/**
	 * Restituisce true se e solo se a è un'azione normalizzata.
	 *
	 * @param a
	 * @return
	 */
	...
	/**
	 * Restituisce true se e solo se ad è una dichiarazione di collegamento
	 * normalizzata.
	 *
	 * @param ad
	 * @return
	...
	public static boolean isNormalizedAttacDecl(AttacDecl ad)
		...
		if (ad.getFromSelector() != null) return false;
		if (ad.getToSelector() != null) return false;
		return true;
		}

	/**
	 * Restituisce true se e solo se i è un'intestazione normalizzata.
	 *
	 * @param i
	 * @return
	 */
	...
	/**
	 * Restituisce true se e solo se pt è un termine di processo normalizzato.
	 *
	 * @param pt
	 * @return
	 */
	...
	/**
	 * Restituisce true se e solo se be è un'equazione di comportamento normalizzata.
	 *
	 * @param be
	 * @return
	 */
	...
	/**
	 * Restituisce true se e solo se et è un tipo di elemento architetturale normalizzato.
	 *
	 * @param et
	 * @return
	 */
	...
	/**
	 * Restituisce true se e solo se id è una dichiarazione di interazione normalizzata.
	 *
	 * @param id
	 * @return
	 */
	public static boolean isNormalizedInteractionDecl(InteractionDecl id)
		...
		if (id.getSelector() != null) return false;
		return true;
		}
	...
	/**
	 * Restituisce true se e solo se at è una topologia con dichiarazioni normalizzate.
	 *
	 * @param at
	 * @return
	 */
	...
	/**
	 * Restituisce true se e solo se at è un tipo architetturale normalizzato.
	 *
	 * @param at
	 * @return
	 */
