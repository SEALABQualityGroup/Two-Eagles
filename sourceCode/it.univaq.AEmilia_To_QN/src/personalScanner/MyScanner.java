...
public class MyScanner {
	 ...
	 * MyScanner. Un token completo è preceduto e seguito da 
	...
	public String next() throws NoSuchElementException
		...
		// si controlla se c'è un delimitatore nell'input
		// osservare che il find è contestale
		if (this.m.find())
			{
			...
			if (st.equals("")) 
				{
				// se il token è la stringa vuota si controlla 
				// se c'è un'altro delimitatore
				if (this.m.find())
					{
					this.m.appendReplacement(ris, "");
					st = new String(ris);
				...
				// se non c'è un altro delimitatore si considera
	 ...
	 * @throws NoSuchElementException - se non è disponibile nessun token.
	...
	public MyScanner skip(String s) throws NoSuchElementException
		...
		if (st.matches(s+"(.)*"))
			...
			// skipped è il token scannerizzato
	 ...
	 * @return un oggetto String.
	 * @throws IllegalStateException - se questo scanner è chiuso.
	 */
